...
*/
CREATE TABLE [dbo].[ActiveIncident]
(
	...
	[CurrentUnits] VARCHAR(255) NULL, 
    [Units] VARCHAR(255) NULL, 
    [LastSeenDT] DATETIME NOT NULL, 
    [ServiceSessionId] BIGINT NOT NULL DEFAULT (0), 
	[Status] VARCHAR(20) NULL,
	[Notes] VARCHAR(100) NULL, 
    CONSTRAINT [FK_ActiveIncident_IncidentType] FOREIGN KEY ([IncidentTypeId]) REFERENCES [IncidentType]([Id])
)
